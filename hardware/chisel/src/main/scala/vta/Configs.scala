...
class DefaultVTAConfig_2x16 extends Config(new CoreConfig_2x16 ++ new VTAConfig)
...
class DefaultVTAConfig_2x32 extends Config(new CoreConfig_2x32 ++ new VTAConfig)
...
object DefaultVTAConfig_2x16 extends App {
  implicit val p: Parameters = new DefaultVTAConfig_2x16
  (new chisel3.stage.ChiselStage).emitSystemVerilog(new VTAShell, args)
}
...
object DefaultVTAConfig_2x32 extends App {
  implicit val p: Parameters = new DefaultVTAConfig_2x32
  (new chisel3.stage.ChiselStage).emitSystemVerilog(new VTAShell, args)
}
